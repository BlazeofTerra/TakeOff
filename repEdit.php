...
include_once 'includes/dbh2.inc.php';
    ...
    $sql = "SELECT * FROM representative WHERE id = 6";
    ...
    if($resultCheck = 0){
        ...
        if ($row = mysqli_fetch_assoc($result)) {
            ...
            $_SESSION['repPosition'] = $row['repPosition'];
            $_SESSION['repEmail'] = $row['repEmail'];
            $_SESSION['repNum'] = $row['repNum'];
                    ...
                    <div class="col-xs-8 col-sm-8 col-md-6 col-lg-6 col-xs-offset-2 col-sm-offset-2 col-md-offset-3 col-lg-offset-3 userRegArea">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form  action="includes/repEdit.inc.php" method="POST">
                                    <div class="dropdown">
                                        <label for="firstName">Rep Office:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="firstName">Rep Name:</label>
                                        <input type="text" class="form-control" id="repName" name="repName"
                                        value="<?php echo("{$_SESSION['repName']}"); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="firstName">Rep Position:</label>
                                        <input type="text" class="form-control" id="repPosition" name="repPosition"
                                        value="<?php echo("{$_SESSION['repPosition']}"); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="lastName">Email Address:</label>
                                        <input type="text" class="form-control" id="repEmail" name="repEmail"
                                        value="<?php echo("{$_SESSION['repEmail']}"); ?>">
                                    </div>
                                
                                    <div class="form-group">
                                        <label for="lastName">Phone Number:</label>
                                        <input type="text" class="form-control" id="repNum" name="repNum"
                                        value="<?php echo("{$_SESSION['repNum']}"); ?>">
                                    </div>
